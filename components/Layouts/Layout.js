...
import Navbar from "../Nav/NavbarMobile";
import NavbarDesktop from "../Nav/NavbarDesktop";
import NavbarFull from "../Nav/NavbarFull";
import { useNavState, useNavStateUpdate } from "../Nav/NavContext";
...
export default function Layout({ children }) {
  ...
  return (
    <div
      className={
        "bg-white dark:bg-matt-dark select-none flex flex-col min-h-full w-full"
      }
    >
      {/* <SEO /> */}
      ...
      <main
        className={
          ...
          (navState ? "opacity-0" : "delay-300 duration-1000 opacity-100")
        }
      >
        {children}
      </main>
